  ...
  return (
    ...
    >
      <div>
        ...
        <div className="relative aspect-[4/3] bg-[#EBE5D8] overflow-hidden">
          <img
          ...
          <div className="absolute top-3 left-3 flex items-center gap-1.5">
            ...
            <button
              ...
              className="px-2 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wider bg-white/95 hover:bg-white text-[#153826] backdrop-blur-sm shadow flex items-center gap-1 border border-[#E8E0D2] transition-all hover:scale-105 cursor-pointer"
            >
              <span>3D</span>
            </button>
          </div>
